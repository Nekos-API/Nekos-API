...
Currently there isn't much that we can give you as a thank you since the idea of the project is to provide a 100% free service for everyone to use, share, and learn. By donating, you'll get beta access to NekoSauce and it's API for a month (you can do a recurring monthly donation if you want to continue having access to the beta version). Basically, your donation helps us cover the costs of running the API while giving you back as much as we can through NekoSauce.

You'll also be added to our [contributors shoutout](/docs#contributors) section at the beginning of Nekos API's documentation, together with donator-only updates in our Discord server.
