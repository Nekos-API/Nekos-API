...
- You <u>must not</u> store the content served by the API for more than an hour, excepting 1) resource IDs (image IDs, category IDs, etc.), 2) artist data, 3) OAuth2 application data, and 4) image files. This includes but is not limited to any API response, partially or complete.
...
WE ARE NOT THE COPYRIGHT HOLDERS OF THE IMAGES PROVIDED BY THE API. THIS MEANS THAT WE ARE NOT RESPONSIBLE FOR ANY COPYRIGHT INFRINGEMENTS THAT YOU MAKE. IF YOU ARE THE COPYRIGHT HOLDER OF ANY IMAGE AND YOU WANT IT TO BE REMOVED, PLEASE CONTACT US AT [dmca@nekosapi.com](mailto:dmca@nekosapi.com).
