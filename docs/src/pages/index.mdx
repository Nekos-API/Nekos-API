...
export const features = [
    {
        ...
        description: "Advanced features and a clean specification will help you build anything you want.",
        icon: <CpuChipIcon />
    },
    {
        title: "Free forever",
        ...
        <div className={styles.main}>
            ...
            <div className={styles.content}>
                <div className="relative">
                    <div className={styles.heroContainer}>
                        ...
                        <p className={styles.mainDescription}>An open-source free public anime images & gifs API.</p>
                    ...
                    <div className="absolute top-8 bottom-0 right-0 overflow-hidden max-w-sm hidden lg:block">
                        <img src="/imgs/landing-neko-1.png" />
                        <Link href="https://www.pixiv.net/en/artworks/72946322" target="_blank" className="absolute bottom-4 right-0 rounded p-2 border border-neutral-200 hover:border-neutral-400 dark:border-neutral-700 dark:hover:border-neutral-600 dark:hover:bg-neutral-900 bg-white dark:bg-black leading-none w-fit text-neutral-800 dark:text-white text-sm flex flex-row items-center gap-2 drop-shadow-sm transition cursor-pointer group">
                            Illustrated by:
                            <b className="flex flex-row items-end">
                                <span className="relative flex flex-col items-center justify-center after:content-['ka'] after:absolute after:bottom-[calc(100%-.0rem)] after:opacity-0 after:left-0 after:right-0 after:block after:mx-auto after:text-[.5rem] after:font-normal after:w-fit after:translate-y-2 after:transition-all group-hover:after:translate-y-0 group-hover:after:opacity-50">か</span>
                                <span className="relative flex flex-col items-center justify-center after:content-['ru'] after:absolute after:bottom-[calc(100%-.0rem)] after:opacity-0 after:left-0 after:right-0 after:block after:mx-auto after:text-[.5rem] after:font-normal after:w-fit after:translate-y-2 after:transition-all group-hover:after:translate-y-0 group-hover:after:opacity-50">る</span>
                            </b>
            ...
            <div className={`${styles.content} ${styles.infoContainer} flex flex-col items-center relative`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-neutral-300 dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-700 rounded-xl overflow-hidden font-mono w-full lg:w-auto mt-8">
                    ...
                    <div className="bg-white dark:bg-neutral-900 px-12 py-4 flex flex-col items-center justify-center text-center">
                        <div className="text-lg">GIFs</div>
                        <div className="text-3xl font-bold">+3k</div>
                    </div>
                    <div className="bg-white dark:bg-neutral-900 px-12 py-4 flex flex-col items-center justify-center text-center">
                        <div className="text-lg">Reactions</div>
                        <div className="text-3xl font-bold">+70</div>
                    </div>
                    <div className="bg-white dark:bg-neutral-900 px-12 py-4 flex flex-col items-center justify-center text-center">
                        <div className="text-lg">Reqs. per month</div>
            ...
            <div className={`${styles.content} ${styles.infoContainer} grid grid-cols-1 md:grid-cols-2 gap-16 relative`}>
                <div>
                    ...
                    <Link className={styles.discordBanner} href="https://discord.gg/b9Fv3kEfXc">
                        <img src="https://invidget.switchblade.xyz/b9Fv3kEfXc" alt="Join our Discord Server" />
                    </Link>
                </div>
                <div>
