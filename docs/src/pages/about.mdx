...
The API is and will be free forever. However, we are currently having problems to pay for the servers. If you really like the API and want to contribute to it, you can make a donation on our [Patreon](https://www.patreon.com/nekidev) page or buy us a cofee at [Ko-Fi](https://ko-fi.com/nekidev) or at [Buy Me A Coffee](https://buymeacoffee.com/nekidev). All donations are welcome :)
