...
-   **Advanced features**: Get many resources in a single request, advanced filters and a clean specification make the API one of the most advanced anime images APIs out there.
