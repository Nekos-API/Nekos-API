...
Nekos API is a free JSON API for anime images and gifs. We try to provide the best service possible and we are always open to suggestions. If you have any questions or suggestions, feel free to [join our Discord server](https://discord.gg/PgQnuM3YnM).
...
-   **Thousands of images**: We have thousands of images (more than 40,000, though they're not all yet available to the public) and we are adding more every day.
